...
export default function CaseStudy() {
    return (
        ...
        <h2 className={styles.header}>Target Audience</h2>
            ...
            <br />
            <br />
            <Link className={styles.demo} href='https://docs.google.com/spreadsheets/d/1kJt4UG44dgGP3s849Wj166taCNonv4402Hu2OA-tiU0/edit?usp=sharing'>Usability Testing</Link>
            <br />
            <br />
            <Link className={styles.demo} href='https://docs.google.com/spreadsheets/d/18jNe4otYjzAbPkG72CNo7rVKZwcHYIQ4pjMklCmBFEU/edit?usp=sharing'>Competitive Analysis</Link>
        </div>
